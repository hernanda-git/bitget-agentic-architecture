...
# Kept only for old offline fixtures. They still pass through the canonical constructor.
LEGACY_EVENT_TYPES = frozenset({"POLICY_REJECTED", "SHADOW_TICK_OBSERVED", "SHADOW_STARTED", "SHADOW_FINISHED", "PROVIDER_DEGRADED", "RISK_BREAKER_OPEN", "RISK_BREAKER_CLOSED", "AGENT_CONTEXT_BUILT"})
SCHEMA_VERSION = 1
